...
/**
 * The methods that are common between RegExFactory and RegExBuilder
 * 
 * @author Chris Topher
...
public interface RegExCommon extends CommonBuilder<RegExBuilder> {
	 ...
	 * 
	 */
	RegExBuilder regEx(RegExBuilder regEx, RegExBuilder... regExN);
	 ...
	 * each object in {@code objN} where 0 &le; <em>i</em> &lt; {@code
	 * objN.length}, <tt>objN[</tt><em>i</em><tt>].toString()</tt> is appended
	 * to the regular expression, escaping special characters as needed.
	 * </p>
	 * 
	 * @param obj
	 ...
	 */
	RegExBuilder regEx(Object obj, Object... objN);
	 ...
	 * @see #regEx(Object)
	 */
	RegExBuilder regEx(byte number);
	 ...
	 * @see #regEx(Object)
	 */
	RegExBuilder regEx(short number);
	 ...
	 * @see #regEx(Object)
	 */
	RegExBuilder regEx(int integer);
	 ...
	 * @see #regEx(Object)
	 */
	RegExBuilder regEx(long number);
	 ...
	 * @see #regEx(Object)
	 */
	RegExBuilder regEx(float number);
	 ...
	 * @see #regEx(Object)
	 */
	RegExBuilder regEx(double number);
	 ...
	 * @see #regEx(Object)
	 */
	RegExBuilder regEx(boolean primitive);
	 ...
	 * @see #regEx(Object)
	 */
	RegExBuilder regEx(char character);
	 ...
	 * @return {@code this} RegExBuilder or a {@code new} one
	 */
	RegExBuilder orNoCaptureGroup(RegExBuilder regEx0, RegExBuilder regEx1,
			RegExBuilder... regExN);

	RegExBuilder orGroup(RegExBuilder regEx0, RegExBuilder regEx1,
			RegExBuilder... regExN);
	 ...
	 * @return {@code this} RegExBuilder or a {@code new} one
	 * @throws IllegalArgumentException
	 *             if the numeric value of {@code min} is greater than {@code
	 *             max}
	 */
	...
	RegExBuilder intersection(CharClassBuilder charClass1,
	 ...
	 * @return {@code this} RegExBuilder or a {@code new} one
	 */
	RegExBuilder repeatAtLeast(int nTimes, RegExBuilder regEx,
			RegExBuilder... regExN);
	 ...
	 * @return {@code this} RegExBuilder or a {@code new} one
	 */
	RegExBuilder repeat(int atLeastNTimes, int atMostMTimes,
	 ...
	 * @return {@code this} RegExBuilder or a {@code new} one
	 */
	RegExBuilder repeatLazy(int nTimes, RegExBuilder regEx,
			RegExBuilder... regExN);
	 ...
	 * @return {@code this} RegExBuilder or a {@code new} one
	 */
	RegExBuilder repeatAtLeastLazy(int nTimes, RegExBuilder regEx,
			RegExBuilder... regExN);
	 ...
	 * @return {@code this} RegExBuilder or a {@code new} one
	 */
	RegExBuilder repeatLazy(int atLeastNTimes, int atMostMTimes,
			RegExBuilder regEx, RegExBuilder... regExN);
	 ...
	 * @return {@code this} RegExBuilder or a {@code new} one
	 */
	RegExBuilder zeroOrMorePossessive(RegExBuilder regEx,
			RegExBuilder... regExN);
	 ...
	 * @return {@code this} RegExBuilder or a {@code new} one
	 */
	RegExBuilder repeatPossessive(int nTimes, RegExBuilder regEx,
			RegExBuilder... regExN);
	 ...
	 * @return {@code this} RegExBuilder or a {@code new} one
	 */
	RegExBuilder repeatAtLeastPossessive(int nTimes, RegExBuilder regEx,
			RegExBuilder... regExN);
	 ...
	 * @return {@code this} RegExBuilder or a {@code new} one
	 */
	RegExBuilder repeatPossessive(int atLeastNTimes, int atMostMTimes,
			RegExBuilder regEx, RegExBuilder... regExN);
	 ...
	 * @return {@code this} RegExBuilder or a {@code new} one
	 */
	RegExBuilder noCaptureGroup(RegExBuilder regEx, RegExMatchFlag flag,
	...
	RegExBuilder turnOnOffMatchFlags(RegExMatchFlag flag,
			RegExMatchFlag... flagN);
	 ...
	 */
	RegExBuilder positiveLookahead(RegExBuilder lookahead,
	 ...
	 *             in {@code lookaheadN} is {@code null}
	 */
	RegExBuilder negativeLookahead(RegExBuilder lookahead,
			RegExBuilder... lookaheadN);
	 ...
	 */
	RegExBuilder positiveLookbehind(RegExBuilder lookbehind,
	 ...
	 *             items in {@code lookbehindN} is {@code null}
	 */
	RegExBuilder negativeLookbehind(RegExBuilder lookbehind,
			RegExBuilder... lookbehindN);
}
